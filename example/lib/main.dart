...
class _MyAppState extends State<MyApp> {
  ...
  void _createClient() async {
    _client =
        await AgoraRtmClient.createInstance('ea9f3341e22940948d0a5ddd55f71901');
  ...
  void _toggleLogin() async {
    if (_isLogin) {
      ...
      try {
        await _client.login('006ea9f3341e22940948d0a5ddd55f71901IAApQ8em33dj/05uIX6ywpmTUFljjhxkl9m47eo+O2mgIDqC+I0AAAAAEACZqwdIxFT7XwEAAQDDVPtf', userId);
